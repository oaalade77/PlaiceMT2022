...
run.dir <- "RT.2022.BridgeRuns/Run2"
run.name <- "WHAM_MT_BRun2"

dat.filename <- "PlaiceWHAM-2019_revised_NEFSC-LW-WAA_splitNEFSC-BigUnit_REVISED_WAA_MAPPING.DAT"

asap3 <- read_asap3_dat(file.path('RT.2022.BridgeRuns/Run2', dat.filename))
