---
title: "Bridge Run #4: Updated parameterization of FXSPR_static"
...
## Model description
Bridge Run #4: Fix specification of FXSPR_static to be based on the last five years
...
dat.filename <- "PlaiceWHAM-2019_revised_NEFSC-LW-WAA_splitNEFSC-BigUnit_REVISED_ALL.DAT"

asap3 <- read_asap3_dat(file.path('RT.2022.BridgeRuns/Run4', dat.filename))
