...
run.dir <- "RT.2022.BridgeRuns/Run1"
run.name <- "WHAM_MT_BRun1"

dat.filename <- "PlaiceWHAM-2019_revised_NEFSC-LW-WAA_splitNEFSC-BigUnit_SURVEYTIMING_REVISED.DAT"

asap3 <- read_asap3_dat(file.path('RT.2022.BridgeRuns/Run1', dat.filename))
