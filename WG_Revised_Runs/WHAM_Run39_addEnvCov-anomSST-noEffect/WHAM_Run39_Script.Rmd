...
## Comment
Minor differences with run 39A (see comments in that run script), AIC slightly larger for run 39A but within +/-2 so suggest no preference for the inclusion of SST anomaly effects.
