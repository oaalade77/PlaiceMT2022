...
# Read in model Rdata
models <- lapply(modelRuns, readRDS)
names(models) <- paste("Run", c(9, 10,11, 13,14,16, "16A",17,19,22, 23, "23A", 24, 25, 26, 27, 28, 29, "29A", "29B", "29C", "29E", 30:35, 37, "37A"), sep="")
...
### Compare run 27 (full NAA random effect) and 29A-C (NEFSC split into Albatross/Bigelow years)
```{r}
# File path
modelRuns <- paste(here::here(), "WG_Revised_Runs",
...
# Read in model Rdata
models <- lapply(modelRuns, readRDS)
names(models) <- paste("Run", c(27, 29, "29A", "29B", "29C"), sep="")
