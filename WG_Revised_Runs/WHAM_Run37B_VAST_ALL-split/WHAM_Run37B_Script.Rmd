...
init_index_sel <- list(c(0.5, 1, 1, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0, 0), # all VAST Albatross spring
                       c(0.5, 1, 1, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0, 0), # all VAST Bigelow spring
                       c(1, 1, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0, 0), # all VAST Albatross fall
                       c(1, 1, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0, 0)) # all VAST Bigelow fall
