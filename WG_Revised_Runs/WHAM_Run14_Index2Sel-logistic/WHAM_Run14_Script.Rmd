...
## Comment
The model converged and the hessian was invertable. The selectivity pattern is similar for the fleet and index 1 (NEFSC spring) which were not altered, but index 2 (NEFSC fall) now has flat topped selectivity reaching 1 around age 5 or 6. 

Overall model fit seems similar between runs 13 an 14, but catchability estimates between index 1 (NEFSC spring) and index 2 (NEFSC fall) are more similar in run 14 than 13 (see "WG_Revised_Runs/WHAM_Run14_Index2Sel-logistic/plots_png/results/q_time_series.png" and "WG_Revised_Runs/WHAM_Run13_FixSelectivity-at-age/plots_png/results/q_time_series.png" plots).
