...
OSA residuals for fit to aggregate fleet and indices were similarly distributed in runs 44 and 44A. The BT anomaly OSA residuals were not very normally distributed in either run. OSA age comp residuals have similar magnitudes and patterns for the fleet and all indices.

AIC was larger in run 44A but still within 2 of the AIC score for run 44 so this run should be considered equivalent. 
