...
## Model description
A full state-space model was implemented as in run 37 (logistic fleet selectivity, age-specific index selectivity, recruitment about the mean, fit to VAST index that combines all observed indices), but an implement an iid random effect for fleet and both index selectivities. 
...
This model had a smaller AIC and Mohn's rho patterns than Run37 (AIC isn't perfectly comparable since different selectivity likelihood contribution). 
