...
input <- prepare_wham_input(asap3, recruit_model = recruit_model, NAA_re = NAA_re, selectivity = sel_list, model_name = "WHAM_Run25") 
```
...
## Comment
Run 25 maximum fleet age comp residuals were slightly larger, index catch likelihood contributions were slighltyl higher and other liklihood contributions were slightly smaller than Run 23. Recruitment residuals at the end of the timeseries are large and negative. Fleet OSA residuals appear more normally distributed, but OSA residuals for both indices appear about as normally distributed as run 23. Recruitment CV at the end of the timeseries is smaller than in run 23.
