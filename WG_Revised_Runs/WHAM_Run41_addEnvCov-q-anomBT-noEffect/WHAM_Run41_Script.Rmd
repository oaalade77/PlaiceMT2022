...
saveRDS(input, file=paste(here::here(), "WG_Revised_Runs", "WHAM_Run41_addEnvCov-anomSST-noEffect", "WHAM_Run41_input.rds", sep="/"))
```

### Fit model, check convergence, and run diagnostics
```{r}
WHAM_Run41 <- fit_wham(input, do.osa = FALSE, do.retro = TRUE) 
...
```{r}
# Save fitted model
saveRDS(WHAM_Run41, file=paste(here::here(), "WG_Revised_Runs", "WHAM_Run41_addEnvCov-anomSST-noEffect", "WHAM_Run41_model.rds", sep="/"))
```
...
inputRerun <- readRDS(paste(here::here(), "WG_Revised_Runs",
                     "WHAM_Run41_addEnvCov-anomSST-noEffect/WHAM_Run41_input.rds", sep="/"))
