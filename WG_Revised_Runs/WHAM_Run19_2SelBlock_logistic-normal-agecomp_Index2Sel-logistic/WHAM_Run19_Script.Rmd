...
## Model description
This run is the same as run 18, with logistic-normal-miss0 age composition model which applies a logistic normal model and treats zero observations as missing, but selectivity for index 2 (NEFSC fall) is logistic.
