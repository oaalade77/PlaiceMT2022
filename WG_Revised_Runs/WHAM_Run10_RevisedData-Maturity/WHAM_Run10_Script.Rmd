...
Major differences from run 1A include: revised discard data (estimated rather than imputed) and an 11+ group in the NEFSC spring and fall surveys (with selectivity of ages 10-11+ initially set at 1).
