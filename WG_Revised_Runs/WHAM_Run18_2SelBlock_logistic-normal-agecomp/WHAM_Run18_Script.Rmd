...
## Model description
This run is the same as run 16, but changes the age composition model from multinomial to logistic-normal-miss0 which applies a logistic normal model and treats zero observations as missing.
