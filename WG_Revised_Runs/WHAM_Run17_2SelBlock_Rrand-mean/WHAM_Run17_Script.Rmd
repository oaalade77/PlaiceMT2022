...
## Model description
This run is the same as run 16 (two selectivity blocks, one from 1980-1999 and another from 2000-2019) and specifies the recruitment relationship as random about the mean but adds a random effect for recruitment (as was done in [run 4](https://github.com/ahart1/PlaiceWG2021/blob/main/Plaice_Baseline_UpdatedData_Runs.Rmd)).
...
## Comment
Age 1 residuals are more evenly distributed about 0 but large negative residuals toward the end of the time series. Unclear why the mean recruitment in the first year is still different from the remaining years
