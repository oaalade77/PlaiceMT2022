...
# Setup random effect by selectivity block (here: fleet, index1, index2) #index 3 selectivity will be the same as the fleet
...
```{r}
WHAM_Run32 <- fit_wham(input, do.osa =F, do.retro=F) 
