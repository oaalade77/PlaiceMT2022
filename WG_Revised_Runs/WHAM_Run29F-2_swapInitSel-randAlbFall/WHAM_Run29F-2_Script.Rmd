...
OSA residuals for the fit to aggregate data for the fleet and all indices for run 29F-2 were similarly or slightly more normally distributed than run 29F-2. OSA residuals for fit to age comp data were similarly distributed in both runs. 
