...
albSpringSel <- models$Run29F1$rep$selAA[[2]][1,] # Albatross spring
bigSpringSel <- models$Run29F1$rep$selAA[[3]][1,] # Bigelow spring
albFallSel <- models$Run29F1$rep$selAA[[4]][1,] # Albatross fall
bigFallSel <- models$Run29F1$rep$selAA[[5]][1,] # Bigelow fall
