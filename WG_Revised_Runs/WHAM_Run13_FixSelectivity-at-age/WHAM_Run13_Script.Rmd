...
Major differences from run 3 include: revised discard data (estimated rather than imputed), and an 11+ group in the NEFSC spring and fall surveys. Selectivity in the .dat file is different than that in run 3, but this is overwritten by the input so it is not a significant difference. Additionally, age 4 and 5 were both fixed at 1 for the NEFSC spring survey while run 3 only fixed age 4 at 1.
