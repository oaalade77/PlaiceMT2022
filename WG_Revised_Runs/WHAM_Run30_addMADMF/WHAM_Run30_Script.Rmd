...
## Comment
Model converged with an invertible hessian when selectivity random effects were included for the fleet but no indices. The model never converged when random effects were included for the survey indices in the full state-space model. 
