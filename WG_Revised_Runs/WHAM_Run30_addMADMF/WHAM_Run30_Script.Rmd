...
# debug NA/NaN
WHAM_Run30 <- fit_wham(input, do.fit=F)
therep = WHAM_Run30$report()
names(therep)
...
## Comment
Model converged with an invertible hessian after reverting to only recruitment random effects and fixing selectivity at age 3 for the MADMF indices. Both index 3 (MADMF spring) and index 4 (MADMF fall) had dome shaped selectivity patterns with peaks at younger ages than the NEFSC indices (MADMF age 3 in spring, 2 & 3 in fall). Age comp residuals for these indices were larger than for the NEFSC indices. 

Catch residuals were larger, age comp residuals for the fleet followed a similar pattern but were slightly larger for age 11+ near the end of the time series and some intermediate years for ages 2-4 in the NEFSC spring index (e.g. 1990 age 4 NEFSC spring index 1). Index 2 (NEFSC fall) had smaller age comp residuals for several years in ages 1-4. Residuals towards the end of the time series was positive for the two NEFSC indices but negative for the two MADMF indices. 

The fleet's age comp likelihood contribution was larger than in Run25, but index 1 and 2 age comp likelihoods and catch likelihoods were similar or smaller than in Run25. Recruitment CV at the end of the time series was higher than Run25. OSA residuals for the fleet are slightly more normally distributed, but index 1 and 2 OSA residuals are similar or slightly less normally distributed than in Run25. 
