...
## Comment
Still several years with large residuals especially at ages 1-3 for the fleet & both surveys. Catch residuals have a consistent pattern of overestimating at the beginning and end of the timeseries and underestimating in the middle. Recruitment residuals are all positive - this is a plotting artifact and the NAA_4panel_1.png plot for runs that treat R as a fixed effect (as is done here) is not an informative diagnostic. There is also a slight retrospective pattern, but this falls within in the middle of the range observed across runs. The fleet and index age comp likelihood contribution is a bit smaller than for run 13.
