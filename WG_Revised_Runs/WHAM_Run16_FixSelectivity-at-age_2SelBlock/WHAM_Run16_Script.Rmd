...
## Model description
This run is the same as run 13, but includes two selectivity blocks, one from 1980-1999 and another from 2000-2019.
...
## Comment
Still several years with large residuals especially at ages 1-3 for the fleet & both surveys. Catch residuals have a consistent pattern of overestimating at the beginning and end of the timeseries and underestimating in the middle. Recruitment residuals are all positive. There is also a slight retrospective pattern.The fleet's age comp likelihood contribution is a bit smaller than for run 13.
