...
tmp$model <- "ADD_NAME_OF_MODEL_FOR_PLOT_HERE" # Keep this short! The name provided here will be included in corresponding .rds and .png names 
df <- rbind(df, tmp) # Append to data

##### Save MASE results #####
res_dir <- here::here("MASE_Diagnostic") # Specify storage
saveRDS(models, file=file.path(res_dir, paste0("MT_", unique(tmp$model), "_models.rds"))) # Save one data object with all models for which MASE was calculated
...
##### Plot MASE results #####
png(here::here("MASE_Diagnostic", paste0("MT_", unique(tmp$model), "_mase_model_horizon_5yr.png")), units='in', res=300, width=6, height=4.5)
...
png(here::here("MASE_Diagnostic", paste0("MT_", unique(tmp$model), "_mase_model_horizon_3yr.png")), units='in', res=300, width=6, height=4.5)
...
png(here::here("MASE_Diagnostic", paste0("MT_", unique(tmp$model), "_mase_model_5yr.png")), units='in', res=300, width=5, height=5)
...
png(here::here("MASE_Diagnostic", paste0("MT_", unique(tmp$model), "_mase_model_3yr.png")), units='in', res=300, width=5, height=5)
