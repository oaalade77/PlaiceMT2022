...
model <- readRDS(file.path(run.dir, "WHAM_MT_Run4_basic_model.rds"))
...
tmp$model <- "Run4_MASE" # Keep this short! The name provided here will be included in corresponding .rds and .png names 
df <- rbind(df, tmp) # Append to data

##### Save MASE results #####
res_dir <- here::here("WHAM_runs/Run4/MASE") # Specify storage
...
##### Plot MASE results #####
png(here::here("WHAM_runs/Run4/MASE", paste0("MT_", unique(tmp$model), "_mase_model_horizon_5yr.png")), units='in', res=300, width=6, height=4.5)
...
png(here::here("WHAM_runs/Run4/MASE", paste0("MT_", unique(tmp$model), "_mase_model_horizon_3yr.png")), units='in', res=300, width=6, height=4.5)
...
png(here::here("WHAM_runs/Run4/MASE", paste0("MT_", unique(tmp$model), "_mase_model_5yr.png")), units='in', res=300, width=5, height=5)
...
png(here::here("WHAM_runs/Run4/MASE", paste0("MT_", unique(tmp$model), "_mase_model_3yr.png")), units='in', res=300, width=5, height=5)
